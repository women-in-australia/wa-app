...
class CreateOgEntity extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      summary: '',
...
CreateOgEntity.propTypes = {
  getFieldDecorator: PropTypes.func,
  getFieldValue: PropTypes.func,
  setFieldsValue: PropTypes.func
};
CreateOgEntity.contextType = LayoutContext;
const WrappedCreateOgEntity = Form.create({ name: 'createOgEntity' })(
  CreateOgEntity
);

export default WrappedCreateOgEntity;
